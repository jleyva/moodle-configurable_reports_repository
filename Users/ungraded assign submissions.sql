...
join prefix_user as u on u.id=asm.userid
 left JOIN prefix_assign_grades AS ag ON ag.assignment=a.id and ag.userid=u.id
where 
(ag.grade<0 or ag.grade is null) and ue.userid=%%USERID%% and cm.module=1
